...
<table>
<tr>
<td width="300" valign="top"><img src="docs/screenshots/00-welcome-card.jpg" width="280"></td>
<td valign="top">
...
<table>
<tr>
<td width="33%" valign="top"><img src="docs/screenshots/01-calon-periksa-aktivasi.jpg" width="240"><br><b>Opsi 1 — Periksa Aktivasi</b><br>Untuk anggota lama: masukkan <b>No. Anggota</b> (mis. <code>KMP-2020-0088</code>); bila cocok, akun langsung aktif tanpa isi form.</td>
<td width="33%" valign="top"><img src="docs/screenshots/02-calon-apa-itu-koperasi.jpg" width="240"><br><b>Opsi 2 — Apa itu Koperasi</b><br>Validasi input (nomor salah → diminta ulang, <code>batal</code> untuk keluar) lalu penjelasan singkat: <i>"kamu bukan nasabah — kamu pemilik"</i>, manfaat & SHU.</td>
<td width="33%" valign="top"><img src="docs/screenshots/03-calon-menu-terkunci.jpg" width="240"><br><b>Opsi 3 — Menu (Terkunci)</b><br>Menu anggota belum bisa diakses sebelum aktivasi; bot mengarahkan ke <b>periksa aktivasi</b> atau <b>aktivasi</b>.</td>
</tr>
<tr>
<td width="33%" valign="top"><img src="docs/screenshots/04-calon-ngobrol-ai.jpg" width="240"><br><b>Opsi 4 — Ngobrol dengan AI</b><br>Asisten AI menjawab pertanyaan bebas (mis. <i>"kenapa harus gabung koperasi?"</i>). Ketik <code>menu</code>/<code>keluar</code> untuk berhenti.</td>
<td width="33%" valign="top"><img src="docs/screenshots/05-calon-aktivasi-submenu.jpg" width="240"><br><b>Opsi 5 — Aktivasi (Sub-menu)</b><br>Pilih jalur: <b>1)</b> Aktivasi kilat (demo), <b>2)</b> Isi form lengkap (12 langkah), atau langsung <b>kirim foto KTP</b>.</td>
...
<table>
<tr>
<td width="300" valign="top"><img src="docs/screenshots/06-aktivasi-ktp-ocr.jpg" width="280"></td>
<td valign="top">
...
<tr>
<td width="300" valign="top"><img src="docs/screenshots/07-aktivasi-kilat-berhasil.jpg" width="280"></td>
<td valign="top">
...
<div align="center">
<img src="docs/screenshots/08-menu-utama.jpg" width="300">
</div>
...
<table>
<tr>
<td width="33%" valign="top"><img src="docs/screenshots/09-menu-01-informasi-saya.jpg" width="240"><br><b>1 · Informasi Saya</b><br>Profil lengkap: data pribadi, data keanggotaan (No. Anggota, status, lencana, skor), ringkasan (simpanan/SHU/poin), & profil koperasi yang diikuti.</td>
<td width="33%" valign="top"><img src="docs/screenshots/10-menu-02-simpanan.jpg" width="240"><br><b>2 · Simpanan Saya</b><br>Rincian simpanan <b>Pokok / Wajib / Sukarela</b> + total. Menandai bila simpanan pokok belum lunas & arahan <code>setor</code>.</td>
<td width="33%" valign="top"><img src="docs/screenshots/11-menu-03-estimasi-shu.jpg" width="240"><br><b>3 · Estimasi SHU</b><br>Perkiraan Sisa Hasil Usaha berjalan, dihitung dari besar simpanan & keaktifan transaksi. Angka final ditetapkan saat e-RAT.</td>
</tr>
<tr>
<td width="33%" valign="top"><img src="docs/screenshots/12-menu-04-pinjaman.jpg" width="240"><br><b>4 · Pinjaman</b><br>Status pinjaman + skema: plafon s/d <b>Rp10.000.000</b>, jasa <b>1%/bln (menurun)</b>, tenor maks <b>12 bulan</b>.</td>
<td width="33%" valign="top"><img src="docs/screenshots/13-menu-05-erat.jpg" width="240"><br><b>5 · e-RAT</b><br>Info Rapat Anggota Tahunan: jadwal (25 Jan 2026), agenda (LPJ, pembagian SHU, pemilihan pengawas), metode <b>hybrid</b>, & hak suara.</td>
<td width="33%" valign="top"><img src="docs/screenshots/14-menu-05-voting.jpg" width="240"><br><b>5 · Voting (Surat Suara)</b><br><b>Surat suara digital</b> → balas 1/2/3 (Setuju/Tidak/Abstain). Suara tercatat (+30 poin) + <b>rekap hasil sementara & kuorum</b> real-time.</td>
</tr>
<tr>
<td width="33%" valign="top"><img src="docs/screenshots/15-menu-06-poin-misi.jpg" width="240"><br><b>6 · Poin & Misi</b><br>Gamifikasi keterlibatan: total poin, lencana, skor /100, & <b>misi mingguan</b> (setor +50, hadir kegiatan +100, ikut voting +150).</td>
<td width="33%" valign="top"><img src="docs/screenshots/16-menu-07-hubungi-pengurus.jpg" width="240"><br><b>7 · Hubungi Pengurus</b><br>Meneruskan permintaan ke pengurus koperasi + info jam layanan (Senin–Jumat & Sabtu).</td>
<td width="33%" valign="top"><img src="docs/screenshots/17-menu-08-ajak-teman.jpg" width="240"><br><b>8 · Ajak Teman (Gotong Royong)</b><br>Program referral: kode ajakan (<code>WARG0001</code>) + poin bonus SHU tiap teman aktivasi. Ada pesan siap-bagikan.</td>
</tr>
<tr>
<td width="33%" valign="top"><img src="docs/screenshots/18-menu-09-preorder-form.jpg" width="240"><br><b>9 · Pre-Order (Form)</b><br>Form pemesanan barang bertahap (produk → jumlah → catatan → kapan butuh). Ketik <code>batal</code> kapan saja.</td>
<td width="33%" valign="top"><img src="docs/screenshots/20-menu-10-keuangan.jpg" width="240"><br><b>10 · Keuangan Saya</b><br>Ringkasan modal (simpanan) & belanja di koperasi, poin referral, & estimasi SHU dalam satu layar.</td>
<td width="33%" valign="top"><img src="docs/screenshots/21-menu-11-ngobrol-ai.jpg" width="240"><br><b>11 · Ngobrol dengan AI</b><br>Asisten AI menjawab pertanyaan bebas anggota (mis. <i>"susah ga daftar koperasi?"</i>) dengan konteks koperasinya.</td>
</tr>
<tr>
<td width="33%" valign="top"><img src="docs/screenshots/22-menu-12-daftar-pengurus.jpg" width="240"><br><b>12 · Daftar Pengurus</b><br>Susunan pengurus (Pengurus, Sekretaris, Bendahara, Pengawas) + kontak resmi.</td>
<td width="33%" valign="top"><img src="docs/screenshots/23-menu-13-pengumuman.jpg" width="240"><br><b>13 · Pengumuman</b><br>Kabar terbaru koperasi (jadwal e-RAT, pembagian SHU 2025, pemilihan pengawas baru).</td>
<td width="33%" valign="top"><img src="docs/screenshots/24-menu-14-anggota-jaga-anggota.jpg" width="240"><br><b>14 · Anggota Jaga Anggota</b><br>Program bantuan antar anggota untuk kesejahteraan bersama (mis. lapor kejanggalan).</td>
</tr>
<tr>
<td width="33%" valign="top"><img src="docs/screenshots/25-menu-15-koperasi-global.jpg" width="240"><br><b>15 · Koperasi Global</b><br>Statistik koperasi <b>se-Indonesia</b> dari database nasional (<b>read-only</b>): total anggota, pengurus, & koperasi terdaftar.</td>
<td width="33%" valign="top"></td>
<td width="33%" valign="top"></td>
</tr>
</table>
...
<table>
<tr>
<td width="300" valign="top"><img src="docs/screenshots/26-setor-simpanan.jpg" width="280"></td>
<td valign="top">
...
<tr>
<td width="300" valign="top"><img src="docs/screenshots/19-menu-09-preorder-kirim.jpg" width="280"></td>
<td valign="top">
...
<table>
<tr>
<td width="300" valign="top"><img src="docs/screenshots/27-voice-note-to-action.jpeg" width="280"></td>
<td valign="top">
...
Semua nilai sensitif diambil dari environment variable — **tidak ada secret di-hardcode**. Salin dari [`.env.example`](.env.example). Ringkasan yang penting:
...
Untuk demo/pilot yang selalu online tanpa laptop menyala, jalankan di **Google Cloud Compute Engine (VM)** dengan `systemd` (auto-restart & nyala saat boot). Panduan lengkap ada di **[DEPLOY.md](DEPLOY.md)**.
...
| Dokumen | Isi |
|---|---|
| **[COMMANDS.md](COMMANDS.md)** | Daftar **lengkap semua perintah** chat (per peran: calon anggota, anggota, admin, demo) |
| **[DEPLOY.md](DEPLOY.md)** | Panduan deploy bot **24/7** di Google Cloud VM (systemd) |
| **[extras/STACK.md](extras/STACK.md)** | Rincian **tech stack**, dependency, & env var |
| **[PANDUAN-SUPABASE.md](PANDUAN-SUPABASE.md)** | Setup database Supabase (dashboard) |
| **[dashboard/](dashboard/)** | Aplikasi **dashboard web** (React + Vite) |
